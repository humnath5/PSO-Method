...
#define numofgeom 282


/* Global Variables*/
double V[numofgeom],rH1I[numofgeom],rH2I[numofgeom],rOI[numofgeom];
double xH1[numofgeom],xH2[numofgeom],xO[numofgeom],xI[numofgeom];
double yH1[numofgeom],yH2[numofgeom],yO[numofgeom],yI[numofgeom];
double zH1[numofgeom],zH2[numofgeom],zO[numofgeom],zI[numofgeom];
